...
async def get_project(
    ...
    if project.owner_id != current_user["id"]:
        raise HTTPException(status_code=403, detail="无权访问此项�?)
...
async def update_project(
    ...
    if project.owner_id != current_user["id"]:
        raise HTTPException(status_code=403, detail="无权修改此项�?)
...
async def delete_project(
    ...
    if project.owner_id != current_user["id"]:
        raise HTTPException(status_code=403, detail="无权删除此项�?)
...
async def get_chapter(
    ...
    if not chapter:
        raise HTTPException(status_code=404, detail="章节不存�?)
