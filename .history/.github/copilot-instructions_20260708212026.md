...
- If you need to use any media assets as placeholders, let the user know these are placeholders and should be replaced with the actual assets later.
...
Before starting a new task in the above plan, update the progress in the plan.
-->
